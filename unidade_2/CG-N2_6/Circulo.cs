...
namespace gcgcg
{
  internal class Ciurculo : ObjetoGeometria
  {
    ...
    private double raio;
    private bool visualizaCentro;
    public Ciurculo(char rotulo, Objeto paiRef, Ponto4D ptoCentro, double raio, int qtdePontos, bool desenhaPontoCentral = false) : base(rotulo, paiRef)
    {
      this.ptoCentral = ptoCentro;
      this.raio = raio;
      this.visualizaCentro = desenhaPontoCentral;
