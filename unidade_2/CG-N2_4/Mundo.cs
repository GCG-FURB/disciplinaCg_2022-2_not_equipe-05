...
namespace gcgcg
{
  class Mundo : GameWindow
  {
    ...
    private List<PrimitiveType> lisaTipoPrimitivo;
    private int controladorTipoPrimitiva = 0;
#if CG_Privado
    ...
    protected override void OnLoad(EventArgs e)
    {
      ...
      lisaTipoPrimitivo = new List<PrimitiveType> {
    ...
    protected override void OnKeyDown(OpenTK.Input.KeyboardKeyEventArgs e)
    {
      ...
      else if (e.Key == Key.E)
      {
        ...
        obj_Retangulo.PrimitivaTipo = lisaTipoPrimitivo[controladorTipoPrimitiva];
        controladorTipoPrimitiva++;
        if (controladorTipoPrimitiva == 9) {
          controladorTipoPrimitiva = 0;
        }
      }
#if CG_Gizmo
      else if (e.Key == Key.O)
