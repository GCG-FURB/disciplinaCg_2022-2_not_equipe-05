...
namespace gcgcg
{
  class Mundo : GameWindow
  {
    ...
    private Ponto4D ptoSrPalito = new Ponto4D(0, 0, 0);
    private double anguloSrPalito = 45;
    private double raioSrPalito = 100;
#if CG_Privado
    ...
    protected override void OnLoad(EventArgs e)
    {
      ...
      obj_SegReta = new SegReta(objetoId, null, ptoSrPalito, anguloSrPalito, raioSrPalito);
    ...
    protected override void OnKeyDown(OpenTK.Input.KeyboardKeyEventArgs e)
    {
      ...
      else if (e.Key == Key.E)
      {
        ...
        ptoSrPalito.X -= 1;
        objetosLista.Remove(obj_SegReta);
        obj_SegReta = new SegReta(objetoId, null, ptoSrPalito, anguloSrPalito, raioSrPalito);
        obj_SegReta.ObjetoCor.CorR = 0; obj_SegReta.ObjetoCor.CorG = 0; obj_SegReta.ObjetoCor.CorB = 0;
        obj_SegReta.PrimitivaTipo = PrimitiveType.Lines;
        obj_SegReta.PrimitivaTamanho = 5;
